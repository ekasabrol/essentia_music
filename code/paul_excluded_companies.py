...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = str(input('Input path to json file with your credentials: '))  #provide address to .json file that contains your password
